...
out = ['''<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="40" viewBox="0 2 1200 40" preserveAspectRatio="none">
<defs>
...
s=re.sub(r'<(?:p|div)><img src="assets/ecosystem-separator.svg"[^>]+/></(?:p|div)>', '<div><img src="assets/ecosystem-separator.svg" width="100%" height="40" alt="" /></div>',s)
p.write_text(s,encoding='utf-8')
assert 'mask=' not in svg
assert svg.count('class="flow ') == 80
print('80 flowing filaments, 8 rails, tightly cropped 40px canvas, hard-cut full-width edges; XML valid.')
