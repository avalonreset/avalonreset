...
You do not need to manually configure, wire together, or keep track of dozens of independent repositories.

All you have to do is grab **[cto-legends](https://github.com/avalonreset/cto-legends)**.

We talk to our agents with our voice. Grab the GitHub link, hand it to your agent, and tell it to install what you need. `cto-legends` takes over from there:
